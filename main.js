...
const bornIn50s = inventors.filter(function(item){
  return item.year >= 1500 && item.year <= 1599;
})
console.log(bornIn50s);

// 2. Give us an array of the inventors first and last names
const firstAndLast = inventors.map(function(item){
...
var alphabetically = people.sort(function(a,b){
  return (a > b) ? 1 : -1
})
